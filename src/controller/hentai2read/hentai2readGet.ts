...
export async function getHentai2read(req: Request, res: Response) {
  try {
     ...
     * curl -i http://localhost:3000/hentai2read/get?book=butabako_shotaone_matome_fgo_hen/1
     * 
     * @apiExample {js} JS/TS
     * import axios from "axios"
     * 
     * axios.get("http://localhost:3000/hentai2read/get?book=butabako_shotaone_matome_fgo_hen/1")
     ...
     *  async with session.get("http://localhost:3000/hentai2read/get?book=butabako_shotaone_matome_fgo_hen/1") as resp:
