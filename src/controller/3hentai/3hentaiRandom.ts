...
export async function random3hentai(req: Request, res: Response) {
  try {
     ...
     * curl -i http://localhost:3000/3hentai/random
     * 
     * @apiExample {js} JS/TS
     * import axios from "axios"
     * 
     * axios.get("http://localhost:3000/3hentai/random")
     ...
     *  async with session.get("http://localhost:3000/3hentai/random") as resp:
