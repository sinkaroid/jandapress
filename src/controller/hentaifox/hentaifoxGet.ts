...
export async function getHentaifox(req: LegacyRequest, res: LegacyResponse) {
  try {
     ...
     * curl -i http://localhost:3000/hentaifox/get?book=123
     * 
     * @apiExample {js} JS/TS
     * import axios from "axios"
     * 
     * axios.get("http://localhost:3000/hentaifox/get?book=123")
     ...
     *  async with session.get("http://localhost:3000/hentaifox/get?book=123") as resp:
