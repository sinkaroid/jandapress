...
export async function randomAsmhentai(req: Request, res: Response) {
  try {
     ...
     * curl -i http://localhost:3000/asmhentai/random
     * 
     * @apiExample {js} JS/TS
     * import axios from "axios"
     * 
     * axios.get("http://localhost:3000/asmhentai/random")
     ...
     *  async with session.get("http://localhost:3000/asmhentai/random") as resp:
