...
export async function getSimplyhentai(req: Request, res: Response) {
  try {
     ...
     * curl -i http://localhost:3000/simply-hentai/get?book=fate-grand-order/fgo-sanbunkatsuhou/all-pages
     * 
     * @apiExample {js} JS/TS
     * import axios from "axios"
     * 
     * axios.get("http://localhost:3000/simply-hentai/get?book=fate-grand-order/fgo-sanbunkatsuhou/all-pages")
     ...
     *  async with session.get("http://localhost:3000/simply-hentai/get?book=fate-grand-order/fgo-sanbunkatsuhou/all-pages") as resp:
